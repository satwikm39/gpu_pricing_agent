    ...
    return (
        <div className="panel p-4 sm:p-5 relative overflow-hidden">
            ...
            <div className="flex justify-between items-start mb-3 gap-2">
                <div>
                    <h3 className="text-slate-400 text-[10px] sm:text-xs font-bold uppercase tracking-wider mb-1 flex items-center gap-1.5">
                ...
                <div className={`text-[10px] sm:text-xs px-2 sm:px-2.5 py-1 rounded-full border shrink-0 ${isProfitable ? 'bg-green-900/20 text-green-400 border-green-500/20' : 'bg-orange-900/20 text-orange-400 border-orange-500/20'}`}>
                    {isProfitable ? 'Profit' : 'Recovering'}
                </div>
            </div>

            <div className="mt-3 sm:mt-4">
                <div className="flex justify-between text-[10px] sm:text-[11px] font-mono text-slate-500 mb-1.5 px-0.5">
